...
-- Map alt-h,j,k,l using the characters generated by OSX
keymap("t", "˙", "<C-\\><C-N><C-W>h", term_opts)
keymap("t", "∆", "<C-\\><C-N><C-W>j", term_opts)
keymap("t", "˚", "<C-\\><C-N><C-W>k", term_opts)
keymap("t", "¬", "<C-\\><C-N><C-W>l", term_opts)
keymap("t", "§", "<C-\\><C-N><C-^>", term_opts)
