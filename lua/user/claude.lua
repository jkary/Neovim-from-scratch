...
vim.keymap.set("n", "<C-a>", "<cmd>ClaudeCode<cr>", { desc = "Toggle Claude", noremap = true, silent = false })
vim.keymap.set("t", "<C-a>", "<cmd>ClaudeCode<cr>", { desc = "Toggle Claude", noremap = true, silent = false })
...
vim.keymap.set("v", "<leader>as", "<cmd>ClaudeCodeSend<cr>", { desc = "Send to Claude", noremap = true, silent = true })
