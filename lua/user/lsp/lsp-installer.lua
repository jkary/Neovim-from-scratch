...
for _, server in pairs(servers) do
	local config_file = vim.fn.stdpath("config") .. "/lua/user/lsp/settings/" .. server .. ".lua"
    local module_name = "user.lsp.settings." .. server
	if vim.uv.fs_stat(config_file) then
		vim.lsp.config[server] = require(module_name)
