local options = {
	...
	-- clipboard handled by osc52.lua
...
-- Custom yamlfmt formatter (reads from stdin)
vim.cmd([[
  let g:neoformat_yaml_yamlfmt = {
    \ 'exe': '/home/jkary/go/bin/yamlfmt',
    \ 'args': ['-'],
    \ 'stdin': 1,
    \ }
...
-- Optional: run prettier on save
vim.cmd([[                                                                                                              
    augroup fmt                                                                                                           
      autocmd!                                                                                                            
      autocmd BufWritePre *.js,*.ts,*.tsx,*.jsx,*.json,*.css,*.html,*.md Neoformat                                        
    augroup END                                                                                                           
  ]])
